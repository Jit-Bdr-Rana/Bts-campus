...
<div class="container-fluid">
      <div class="row" style="justify-content: center;color: white; background-color: #1a237e;"><h5>Notice Board</h5></div>
      <?php 
  ...
  <ul class="pagination justify-content-center">
    <li class="page-item">
     <?php if($page>=2){  
        ?><li class='page-item'> 
          <?php 
            echo "<a class='page-link' href='readmore_notice.php?page=".($page-1)."'>  Prev </a>";   
        ?>
        </li>
        <?php 
        }  ?> 
    ...
    <li class="page-item">
      <?php  
$result_db = mysqli_query($db,"SELECT COUNT(id) FROM notice"); 
...
$pagLink .= "<li class='page-item'><a class='page-link' class ='active' href='readmore_notice.php?page=".$i."' >".$i."</a></li>"; 
}
echo $pagLink . "</ul>";  
?>
</li>
...
<?php 
  if($page<$total_pages){
        ...
        <li class='page-item'>
        <?php   
            echo "<a class='page-link' href='readmore_notice.php?page=".($page+1)."'>  Next </a>"; ?>
            </li>
            <?php  
        }   
  ?>
...
<script>   
    ...
    {   
        ...
        window.location.href = 'readmore_notice.php?page='+page;   
    }   
  </script>
    <!-- footer -->
